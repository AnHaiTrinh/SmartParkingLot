...
from ..models.models import Camera, Sensor
...
CameraAuthDependency = Annotated[Camera, Depends(get_camera_by_api_key)]
SensorAuthDependency = Annotated[Sensor, Depends(get_sensor_by_api_key)]
